...
wxBEGIN_EVENT_TABLE(MyTaskBarIcon, wxTaskBarIcon)
    ...
    EVT_TASKBAR_BALLOON_CLICK(MyTaskBarIcon::OnNotificationMessageClick)
wxEND_EVENT_TABLE()

void MyTaskBarIcon::OnNotificationMessageClick(wxTaskBarIconEvent& event)
{
    wxMessageBox("You clicked on a notification!");
}
