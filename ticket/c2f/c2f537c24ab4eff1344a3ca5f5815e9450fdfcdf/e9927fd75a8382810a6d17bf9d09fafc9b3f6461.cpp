        ...
        : wxFrame(parent, id, title, pos, size, style)
{
    ...
    m_tb2 = new wxAuiToolBar(this, wxID_ANY, wxDefaultPosition, wxDefaultSize,
                             wxAUI_TB_DEFAULT_STYLE | wxAUI_TB_HORIZONTAL);
    m_tb2->SetToolBitmapSize(wxSize(16,16));

    wxBitmap tb2_bmp1 = wxArtProvider::GetBitmap(wxART_QUESTION, wxART_OTHER, wxSize(16,16));
    m_tb2->AddTool(ID_SampleItem+6, wxT("Disabled"), tb2_bmp1);
    m_tb2->AddTool(ID_SampleItem+7, wxT("Test"), tb2_bmp1);
    m_tb2->AddTool(ID_SampleItem+8, wxT("Test"), tb2_bmp1);
    m_tb2->AddTool(ID_SampleItem+9, wxT("Test"), tb2_bmp1);
    m_tb2->AddSeparator();
    m_tb2->AddTool(ID_SampleItem+10, wxT("Test"), tb2_bmp1);
    m_tb2->AddTool(ID_SampleItem+11, wxT("Test"), tb2_bmp1);
    m_tb2->AddSeparator();
    m_tb2->AddTool(ID_SampleItem+12, wxT("Test"), tb2_bmp1);
    m_tb2->AddTool(ID_SampleItem+13, wxT("Test"), tb2_bmp1);
    m_tb2->AddTool(ID_SampleItem+14, wxT("Test"), tb2_bmp1);
    m_tb2->AddTool(ID_SampleItem+15, wxT("Test"), tb2_bmp1);
    //m_tb2->SetCustomOverflowItems(prepend_items, append_items);
    m_tb2->EnableTool(ID_SampleItem+6, false);
    m_tb2->Realize();

    m_tb2->GetToolBarFits();
    ...
    m_mgr.AddPane(m_tb2, wxAuiPaneInfo().
...
{
    if(m_tb2)
        m_tb2->SetOverflowVisible(!m_tb2->GetToolBarFits());
