...
bool wxPropertyGrid::DoPropertyChanged( wxPGProperty* p, unsigned int selFlags )
{
 ...
 //wns - june 2012 - after a failed field edit, which we clean out, then quit the form
// can get here with this field null.
// in debug, we crash later on.., in release, we crash here.
// so, handle fact of it being a valid scenario....
//    wxASSERT( m_chgInfo_changedProperty != NULL );
if ( m_chgInfo_changedProperty != NULL )
{
