...
public:
    ...
    void OnCheckButton1(wxCommandEvent& event);
    void OnCheckButton2(wxCommandEvent& event);
...
enum
{
    ...
    INTERNAT_RADIO_BUTTON_1,
    INTERNAT_RADIO_BUTTON_2,
    INTERNAT_CHECK_BUTTON_1,
    INTERNAT_CHECK_BUTTON_2,
    INTERNAT_MACRO_1,
    INTERNAT_MACRO_2,
    INTERNAT_MACRO_3,
    INTERNAT_MACRO_4,
...
wxBEGIN_EVENT_TABLE(MyFrame, wxFrame)
    ...
    EVT_MENU(INTERNAT_RADIO_BUTTON_1, MyFrame::OnRadioButton1)
    EVT_MENU(INTERNAT_RADIO_BUTTON_2, MyFrame::OnRadioButton2)
    EVT_MENU(INTERNAT_CHECK_BUTTON_1, MyFrame::OnCheckButton1)
    EVT_MENU(INTERNAT_CHECK_BUTTON_2, MyFrame::OnCheckButton2)
wxEND_EVENT_TABLE()
...
printf("Couldn't find/load the 'internat' catalog for locale '%s'.",
                   pInfo ? pInfo->GetLocaleName().mb_str(wxConvUTF8) : "unknown");
    }
         ...
         m_locale(locale)
{
    ...
    test_menu->AppendSeparator();
    test_menu->Append(INTERNAT_RADIO_BUTTON_1, _("Radio Button 1"), _("Tests radio button 1st entry"), wxITEM_RADIO);
    test_menu->Append(INTERNAT_RADIO_BUTTON_2, _("Radio Button 2"), _("Tests radio button 2nd entry"), wxITEM_RADIO);
    test_menu->AppendSeparator();
    test_menu->Append(INTERNAT_CHECK_BUTTON_1, _("Check Button 1"), _("Tests check button 1st entry"), wxITEM_CHECK);
    test_menu->Append(INTERNAT_CHECK_BUTTON_2, _("Check Button 2"), _("Tests check button 2nd entry"), wxITEM_CHECK);
    test_menu->Check(INTERNAT_CHECK_BUTTON_2, true);
...
void MyFrame::OnRadioButton1(wxCommandEvent& WXUNUSED(event))
{
    GetMenuBar()->Check(INTERNAT_RADIO_BUTTON_1, true);
    GetMenuBar()->Refresh();
}

void MyFrame::OnRadioButton2(wxCommandEvent& WXUNUSED(event))
{
    GetMenuBar()->Check(INTERNAT_RADIO_BUTTON_2, true);
    GetMenuBar()->Check(INTERNAT_RADIO_BUTTON_1, false);
    GetMenuBar()->Refresh();
}

void MyFrame::OnCheckButton1(wxCommandEvent& WXUNUSED(event))
{
    GetMenuBar()->Check(INTERNAT_CHECK_BUTTON_1, (GetMenuBar()->IsChecked(INTERNAT_CHECK_BUTTON_1) ? true : false));
    GetMenuBar()->Refresh();
}

void MyFrame::OnCheckButton2(wxCommandEvent& WXUNUSED(event))
{
    GetMenuBar()->Check(INTERNAT_CHECK_BUTTON_2, (GetMenuBar()->IsChecked(INTERNAT_CHECK_BUTTON_2) ? true : false));
    GetMenuBar()->Refresh();
}
