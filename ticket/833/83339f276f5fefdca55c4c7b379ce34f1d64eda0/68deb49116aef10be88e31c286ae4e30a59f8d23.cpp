...
MyGLCanvas::MyGLCanvas(wxWindow* parent, float r, float g, float b) : 
    wxGLCanvas(parent, wxID_ANY, wxDefaultPosition), m_r(r), m_g(g), m_b(b)
{
}
...
MyDialog::MyDialog() : wxDialog(NULL, wxID_ANY, _("MAC wxGLCanvas bug demo"),
		wxDefaultPosition, wxDefaultSize, wxCAPTION|wxRESIZE_BORDER|wxSYSTEM_MENU|wxCLOSE_BOX)
{
    ...
    MyGLCanvas* glCanvas = new MyGLCanvas(itemNotebook, 255.f, 0, 0);
