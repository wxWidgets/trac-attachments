...
class FlexGridSizerDemo(wx.Frame):
    def __init__(self, parent, title):
        ...
        workaround_sizer_1 = wx.BoxSizer(wx.VERTICAL)
        workaround_sizer_1.Add((1,1), 1, wx.EXPAND)
        workaround_sizer_1.Add(cb1, 0, wx.EXPAND|wx.ALL)
        workaround_sizer_1.Add((1,1), 1, wx.EXPAND)
        sizer.Add(workaround_sizer_1, 0, wx.EXPAND)
        ...
        workaround_sizer_2 = wx.BoxSizer(wx.VERTICAL)
        workaround_sizer_2.Add((1,1), 1, wx.EXPAND)
        workaround_sizer_2.Add(cb3, 0, wx.EXPAND|wx.ALL)
        workaround_sizer_2.Add((1,1), 1, wx.EXPAND)
        sizer.Add(workaround_sizer_2, 0, wx.EXPAND)
        sizer.Add(button3, 0, wx.EXPAND|wx.ALL)
