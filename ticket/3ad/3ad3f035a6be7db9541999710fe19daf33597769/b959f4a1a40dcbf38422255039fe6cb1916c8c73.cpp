...
// Modified by:
// Created:     07.04.02
// RCS-ID:      $Id: keyboard.cpp 53394 2008-04-28 11:09:20Z VS $
         ...
         m_skip(true)
{
    ...
    menuFile->AppendCheckItem(SkipID, "always call event.&Skip()\tCtrl-S");
...
{
    wxString msg = "Demonstrates keyboard event processing in wxWidgets\n"
                   "(c) 2002 Vadim Zeitlin";

    wxMessageBox(msg, "About wxKeyboard", wxOK | wxICON_INFORMATION, this);
}
