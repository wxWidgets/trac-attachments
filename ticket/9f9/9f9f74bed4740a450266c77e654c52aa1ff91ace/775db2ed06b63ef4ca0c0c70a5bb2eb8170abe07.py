...
class TestPanel(wx.Panel):
    def __init__(self, parent, log):
        ...
        self.txt = wx.TextCtrl(self, value="I'm a ticker!!!!")
        ...
        #       Do layout
        sz = wx.GridSizer(cols=2, hgap=4, vgap=4)
        #sz = wx.FlexGridSizer(cols=2, hgap=4, vgap=4)
        #sz.AddGrowableCol(0, 0)
        #sz.SetFlexibleDirection(wx.HORIZONTAL)
        #sz.SetNonFlexibleGrowMode(wx.FLEX_GROWMODE_NONE)
        ...
        sz2.Add(self.ticker, flag=wx.EXPAND|wx.BOTTOM, border=5)
        sz2.Add(sz, flag=wx.EXPAND|wx.RIGHT, proportion=1, border=10)
        self.SetSizer(sz2)
