...
// Id:          $Id: webview.cpp 72461 2012-09-11 09:26:58Z SJL $
    ...
    wxFrame(NULL, wxID_ANY, "wxWebView Sample")
{
    ...
    Connect(ID_TIMER1, wxEVT_TIMER, wxTimerEventHandler(WebFrame::OnTimer), NULL, this);
	
	m_update_timer.SetOwner(this, ID_TIMER1);
	m_update_timer.Start(20000, wxTIMER_CONTINUOUS); 	
}

void WebFrame::OnTimer(wxTimerEvent&)
{
	m_browser->Reload();
}
