...
{
    if ( xx )
// GDLC 20080919 Parameters x and y are in scroll units and the outputs to xx and yy
// are in pixels. m_xScrollPosition and m_yScrollPosition are also in scroll units.
// Therefor the source code lines commented out below are wrong.
// Why on earth was this not discovered earlier than this???
