...
class stcPanel : public wxPanel 
{
	...
	public:
		...
		stcPanel( wxWindow* parent, wxWindowID id = wxID_ANY, const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( 500,300 ), long style = wxTAB_TRAVERSAL ); 
		~stcPanel();
                    ...
                    wxDEFAULT_FRAME_STYLE | wxNO_FULL_REPAINT_ON_RESIZE)
{
    ...
    // open first page
	stcPanel *panel = new stcPanel(this);
   // m_edit = new Edit (this, wxID_ANY);
	m_edit = panel->stc_edit;
    m_edit->SetFocus();
...
stcPanel::stcPanel( wxWindow* parent, wxWindowID id, const wxPoint& pos, const wxSize& size, long style ) : wxPanel( parent, id, pos, size, style )
{
	wxBoxSizer* bSizer1;
	...
	stc_edit = new Edit ( m_panel1, wxID_ANY);
	//m_textCtrl2 = new wxTextCtrl( m_panel1, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
	bSizer2->Add(stc_edit, 1, wxALL|wxEXPAND, 5 );
	
	
	m_panel1->SetSizer( bSizer2 );
	m_panel1->Layout();
	bSizer2->Fit( m_panel1 );
	m_auinotebook1->AddPage( m_panel1, wxT("Page One"), false, wxNullBitmap );

	wxStyledTextCtrl *stc_page2 = new wxStyledTextCtrl( m_auinotebook1, wxID_ANY);
	m_auinotebook1->AddPage(stc_page2, wxT("Page Two"), false, wxNullBitmap );
	
	wxStyledTextCtrl *stc_page3 = new wxStyledTextCtrl( m_auinotebook1, wxID_ANY);
	m_auinotebook1->AddPage(stc_page3, wxT("Page Three"), false, wxNullBitmap );

	wxStyledTextCtrl *stc_page4 = new wxStyledTextCtrl( m_auinotebook1, wxID_ANY);
	m_auinotebook1->AddPage(stc_page4, wxT("Page 4"), false, wxNullBitmap );
