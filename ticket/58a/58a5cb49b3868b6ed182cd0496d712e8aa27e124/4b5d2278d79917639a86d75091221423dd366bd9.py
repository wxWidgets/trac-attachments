...
#
# Created:     12/31/03
# RCS-ID:      $Id: MimeTypesManager.py,v 1.8 2004/04/22 22:57:01 RD Exp $
# Copyright:
...
class MimeTypesDemoPanel(wx.Dialog):
    def __init__(self, *args,**kwds):
        ...
        self.icon = wx.StaticBitmap(self, -1, wx.EmptyBitmap(16,16))
