...
public:
    ...
    void OnUpdateCount(wxCommandEvent& event);
...
BEGIN_EVENT_TABLE(VScrollFrame, wxFrame)
    ...
    EVT_MENU(VScroll_Update, VScrollFrame::OnUpdateCount)
                      ...
                      wxSize(400, 350))
{
    ...
    menuFile->Append(VScroll_Update, _T("Update line count"), _T("Update line count"));
    ...
    m_vscroll = new VScrollWindow(this);
}
...
void VScrollFrame::OnUpdateCount(wxCommandEvent& WXUNUSED(event))
{
    // note that nunber of lines is not really changed
    m_vscroll->SetLineCount(200);
}
