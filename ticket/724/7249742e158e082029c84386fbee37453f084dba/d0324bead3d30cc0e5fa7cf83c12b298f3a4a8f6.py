...
class TestPanel(wx.Panel):
    def __init__(self, parent, log):
        ...
        btn = wx.Button(self, -1, 'Up')
        btnSizer.Add(btn, 0, wx.ALIGN_CENTER_VERTICAL)
        btn.Bind(wx.EVT_BUTTON, self.onButtonUp)

        btn = wx.Button(self, -1, 'Down')
        btnSizer.Add(btn, 0, wx.ALIGN_CENTER_VERTICAL)
        btn.Bind(wx.EVT_BUTTON, self.onButtonDown)
    ...
    def onButtonUp(self, event):
        #self.vlb.SetScrollbar(wx.VERTICAL, 0, 16, 50)
        #print self.vlb.GetScrollRange(wx.VERTICAL)
        #print self.vlb.GetScrollThumb(wx.VERTICAL)
        print self.vlb.ScrollRowPages(None)
