...
#ifdef __GNUG__
    #pragma implementation "textbuffer.h"
#endif
...
wxTextBuffer::wxTextBuffer(const wxString& strBufferName) : m_strBufferName(strBufferName)
{
    m_nCurLine = 0;
    m_isOpened = FALSE;
}
...
// ----------------------------------------------------------------------------
// wxMemoryText implementation
// ----------------------------------------------------------------------------

wxMemoryText::wxMemoryText(const wxString& strBufferName)
    : wxTextBuffer(strBufferName)
{
}
