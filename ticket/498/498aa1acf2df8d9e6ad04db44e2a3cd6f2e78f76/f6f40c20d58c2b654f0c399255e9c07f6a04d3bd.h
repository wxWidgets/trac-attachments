...
protected:
    ...
    virtual bool OnWrite(wxTextFileType typeNew, wxMBConv& conv = wxConvLibc) = 0;
...
public:
    // Constructors.
    wxMemoryText() { }
    wxMemoryText(const wxString& strBufferName);

protected:
    virtual bool OnExists() const { return false; }
    virtual bool OnOpen(const wxString &strBufferName, wxTextBufferOpenMode OpenMode) { return true; }
    virtual bool OnClose() { return true; }
    virtual bool OnRead(wxMBConv& conv) { return true; }
    virtual bool OnWrite(wxTextFileType typeNew, wxMBConv& conv = wxConvLibc) { return true; }
};
