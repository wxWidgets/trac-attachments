...
IMPLEMENT_DYNAMIC_CLASS( MyResizableListCtrl, wxPanel )

//-----------------------------------------------------------------------------
// Event table: connect the events to the handler functions to process them
//-----------------------------------------------------------------------------

BEGIN_EVENT_TABLE( MyResizableListCtrl, wxPanel )
   ...
   : wxPanel( parent, id, pos, size, style,  name )
{
 ...
 /*  // columns to resize (else an assert on WXGTK debug build).
	...
	sz->Add(new wxStaticText(this, -1, wxT("longlonglonglonglonglonglonglonglonglonglonglonglonglonglonglonglonglonglonglonglonglonglonglonglonglonglonglonglonglonglonglonglonglonglonglonglonglonglonglonglonglonglonglonglong")),
			1, 5, wxGROW);
	SetSizer(sz);
