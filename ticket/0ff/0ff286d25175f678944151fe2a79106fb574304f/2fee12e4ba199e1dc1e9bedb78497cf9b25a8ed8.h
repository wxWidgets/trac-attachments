...
#ifndef   WX_STL_VECTOR_H
#define   WX_STL_VECTOR_H
...
protected:
	...
	//**********************
	// Big gotcha to remember for C++
	// overrides of virtual functions are *not* accessible to base class constructors/destructors
	// hence they should never be called in them
	// i.e this is why clear() is not called in the wxVectorBase destructor
...
#define WX_DECLARE_STL_VECTORBASE(obj, cls)\
private:\
...
#define WX_DECLARE_STL_VECTOR(obj, cls)\
