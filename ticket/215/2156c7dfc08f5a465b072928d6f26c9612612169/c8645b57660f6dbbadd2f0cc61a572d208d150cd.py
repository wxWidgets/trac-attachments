...
class TestPanel(scrolled.ScrolledPanel):
    def __init__(self, parent, log):
        ...
        bsizer = wx.StaticBoxSizer(wx.StaticBox(self, -1, "StaticBox 1"), wx.VERTICAL)
        bsizer.Add(wx.StaticText(self, -1, "Contents of StaticBox 1"), 0, wx.TOP|wx.LEFT, 10)
        hsizer.Add(bsizer,0,wx.ALL,10)

        bsizer = wx.StaticBoxSizer(wx.StaticBox(self, -1, "StaticBox 2"), wx.VERTICAL)
        bsizer.Add(wx.StaticText(self, -1, "yadda yadda"), 0, wx.TOP|wx.LEFT, 10)
        bsizer.Add(wx.StaticText(self, -1, "yadda yadda"), 0, wx.TOP|wx.LEFT, 10)
        bsizer.Add(wx.StaticText(self, -1, "yadda yadda"), 0, wx.TOP|wx.LEFT, 10)
        hsizer.Add(bsizer,0,wx.ALL,10)

        bsizer = wx.StaticBoxSizer(wx.StaticBox(self, -1, "StaticBox 3"), wx.VERTICAL)
        bsizer.Add(wx.StaticText(self, -1, "and so on..."), 0, wx.TOP|wx.LEFT, 10)
        hsizer.Add(bsizer,0,wx.ALL,10)
        
        vbox.Add(hsizer, 1, wx.EXPAND|wx.ALL, 25)
