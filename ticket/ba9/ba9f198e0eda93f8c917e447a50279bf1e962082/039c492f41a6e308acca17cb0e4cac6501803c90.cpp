...
// Created:     04/01/98
// RCS-ID:      $Id: penguin.cpp,v 1.16 2006/11/10 15:16:02 VZ Exp $
...
#  endif
    ...
    m_canvas = new TestGLCanvas(panel, wxID_ANY, wxDefaultPosition,
        wxDefaultSize, wxSUNKEN_BORDER, "Penguin", gl_attrib);

    sizer->Add(m_canvas, 1, wxALL|wxEXPAND, 0);
}
...
TestGLCanvas::TestGLCanvas(wxWindow *parent, wxWindowID id,
    const wxPoint& pos, const wxSize& size, long style, const wxString& name, int * attrib)
    : wxGLCanvas(parent, id, pos, size, style|wxFULL_REPAINT_ON_RESIZE, name, attrib)
{
