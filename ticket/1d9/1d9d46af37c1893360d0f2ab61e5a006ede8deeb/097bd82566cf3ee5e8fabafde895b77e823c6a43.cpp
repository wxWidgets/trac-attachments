...
MyFrame::MyFrame(wxWindow *parent) : wxFrame(parent, wxID_ANY, wxT("PropertyGrid Test"))
{
	...
	pg->Append(new wxEditEnumProperty(_T("wxEditEnumProperty"), wxPG_LABEL, eech, _T("Misaligned on edit")));

	pg->Append(new wxStringProperty(_T("wxStringProperty"), wxPG_LABEL, _T("Works as expected")));
