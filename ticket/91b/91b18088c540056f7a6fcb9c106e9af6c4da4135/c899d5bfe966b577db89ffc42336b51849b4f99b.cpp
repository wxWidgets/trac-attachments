...
//EVT_RADIOBUTTON	 (ID_CHOICE_DISABLE,	MyPanel::OnChoiceButtons)
#endif
...
wxBoxSizer *testSizer = new wxBoxSizer(wxHORIZONTAL);
	...
	wrapping_sizer->Add(m_radio1 = new wxRadioButton( panel, ID_PANEL_DISABLE, _T("Enable"), wxPoint(300, 120), wxDefaultSize));
	wrapping_sizer->Add(new wxRadioButton( panel, ID_PANEL_DISABLE, _T("Disable"), wxPoint(300, 140), wxDefaultSize));
