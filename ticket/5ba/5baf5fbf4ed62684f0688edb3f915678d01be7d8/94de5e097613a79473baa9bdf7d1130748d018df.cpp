...
// Modified by: Ron Lee
// Created:
// RCS-ID:      $Id: sizer.cpp,v 1.76 2004/01/20 18:18:48 SC Exp $
...
void wxSizer::DoShowItems( bool show )
{
    wxSizerItemList::compatibility_iterator node = m_children.GetFirst();
    while (node)
    {
...
void wxStaticBoxSizer::DoShowItems( bool show )
{
    m_staticBox->Show( show );
    wxSizer::DoShowItems( show );
}
