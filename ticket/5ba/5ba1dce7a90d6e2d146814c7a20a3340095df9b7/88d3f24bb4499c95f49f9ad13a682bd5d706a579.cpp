...
// RCS-ID:      $Id: griddemo.cpp,v 1.23 2006/12/04 10:47:02 VZ Exp $
                   ...
                   wxDefaultSize )
{
    ...
    grid->SetCellEditor(0, 6, new wxGridCellFloatEditor(3, 3));
    grid->SetCellRenderer(0, 6, new wxGridCellFloatRenderer);
