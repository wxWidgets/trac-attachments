...
class HyperTreeList(HTL.HyperTreeList):
    ...
    def OnBeginDrag(self, event):
        ...
        self.item = event.GetItem()
        if self.item:
            self.log.write("Beginning to drag item: " + self.item.GetText() + "\n")
    ...
    def OnBeginRDrag(self, event):
        ...
        self.item = event.GetItem()
        if self.item:
            self.log.write("Beginning to right drag item: " + self.item.GetText() + "\n")
    ...
    def OnEndDrag(self, event):
        ...
        self.item = event.GetItem()
        if self.item:
            self.log.write("Ending drag onto item: " + self.item.GetText() + "\n")
