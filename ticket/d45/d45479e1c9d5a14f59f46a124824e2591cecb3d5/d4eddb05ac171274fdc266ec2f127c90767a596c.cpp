...
// ----------------------------------------------------------------------------
	...
	static wxWindow *wxFindWindowById1 (const long id, wxWindow *parent);
#endif // wxUSE_GUI
...
wxWindow *
wxFindWindowById (const long id, wxWindow * parent)
{
    if (parent)
    {
...
// Recursive
static wxWindow *
wxFindWindowById1 (const long id, wxWindow * parent)
{
  if (parent)
    {
            if ( parent->GetId() == id )
