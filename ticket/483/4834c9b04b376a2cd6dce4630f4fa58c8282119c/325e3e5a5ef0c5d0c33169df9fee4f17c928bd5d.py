...
class MyFrame(wx.Frame):
    def __init__(self, parent):
        wx.Frame.__init__(self, parent, -1, "Click for mouseposition", size=wx.Size(1000,300),
        ...
        self.bitmap1=CubeCanvas(self.panelleft)
        ...
        self.sizerPanelLeft.Add(self.btn, 1, wx.ALL|wx.EXPAND|wx.ALIGN_CENTER|wx.SHAPED, 5)
              
        self.SetSizer(self.sizerModifiable)
    ...
    def OnButton(self,evt):
        ...
        self.SendSizeEvent()
        if onPatch:
            wx.CallAfter(self.stupidFunc)

    def stupidFunc(self):
        print 'on stupid func'
