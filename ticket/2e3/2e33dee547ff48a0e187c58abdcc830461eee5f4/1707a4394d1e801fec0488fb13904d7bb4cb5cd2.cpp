...
public:
	...
	void ToggleTooltips(wxCommandEvent& event);
...
BEGIN_EVENT_TABLE(MyFrame, wxFrame)
    ...
    EVT_MENU_RANGE(IDM_TOOLBAR_SHOW_TEXT, IDM_TOOLBAR_SHOW_BOTH,
				   ...
				   EVT_MENU(IDM_TOOLBAR_TOGGLETOOLTIPS, MyFrame::ToggleTooltips)
       ...
       : wxFrame(parent, id, title, pos, size, style)
{
	...
	tbarMenu->AppendSeparator();
	tbarMenu->AppendCheckItem(IDM_TOOLBAR_TOGGLETOOLTIPS, _T("Toggle tooltips"));
    ...
    // Create the toolbar
    RecreateToolbar();
	GetToolBar()->SetWindowStyle( GetToolBar()->GetWindowStyle() | TBSTYLE_TOOLTIPS );
...
void MyFrame::ToggleTooltips(wxCommandEvent& WXUNUSED(event))
{
	long style = GetToolBar()->GetWindowStyle();
