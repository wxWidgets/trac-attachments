      ...
      m_stereoWarningAlreadyDisplayed(false)
{
    ...
    // TODO: BEGIN CODE ADDED
	Connect(this->GetId(), wxEVT_MOTION, wxMouseEventHandler(TestGLCanvas::ProcessMouseEvents));
	Connect(this->GetId(), wxEVT_LEFT_DOWN, wxMouseEventHandler(TestGLCanvas::ProcessMouseEvents));
	Connect(this->GetId(), wxEVT_LEFT_UP, wxMouseEventHandler(TestGLCanvas::ProcessMouseEvents));
}
...
void TestGLCanvas::OnPaint(wxPaintEvent& WXUNUSED(event))
{
    ...
    /*
	 * TODO: CODE ADDED HERE
     * THE PURPOSE OF THIS IS TO SIMULATE A ZOOM RECTANGLE
     */
    /**/
...
/*
 *  TODO: BEGIN: CODE ADDED -
 *  PURPOSE: TRACK MOUSE POSITION TO DRAW ZOOM RECTANGLE
 */
void TestGLCanvas::ProcessMouseEvents(wxMouseEvent& event) {
	if (event.LeftDown()) {
		wxPoint leftButtonDownPosition = event.GetPosition();
		xP1 = xP2 = leftButtonDownPosition.x;
		yP1 = xP2 = leftButtonDownPosition.y;
	}
	if (event.LeftUp()) {
