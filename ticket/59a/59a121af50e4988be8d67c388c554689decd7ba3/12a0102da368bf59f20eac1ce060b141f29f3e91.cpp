...
// Created:     04/01/98
// RCS-ID:      $Id: dialogs.cpp,v 1.118 2004/11/18 16:20:04 RN Exp $
             ...
             : wxDialog(parent, wxID_ANY, wxString(_T("Modal dialog")))
{
    ...
    wxRadioButton *rb1 = new wxRadioButton(this, wxID_ANY, _T("&Radio1"), wxDefaultPosition, wxDefaultSize, wxRB_GROUP );
    wxRadioButton *rb2 = new wxRadioButton(this, wxID_ANY, _T("&Radio2"), wxDefaultPosition, wxDefaultSize, 0 );
    ...
    sizerTop->Add(rb1, 0, wxALIGN_CENTER | wxALL, 5);
    sizerTop->Add(rb2, 0, wxALIGN_CENTER | wxALL, 5);
